...
namespace AlquilerDeVideoJuegos_History.Controllers
{
    public class VideoGamesController : Controller
    {
        ...
        public VideoGamesController(MyDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,TypeGame")] VideoGame videoGame)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TypeGame")] VideoGame videoGame)
        {
            if (id != videoGame.Id)
            {
                return NotFound();
